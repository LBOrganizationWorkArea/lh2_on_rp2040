...
#include "solve3d/ray_cross.h"   /* lh2_bs_pose_t, ray_cross_solve, lh2_point3d_t */
...
int main(void)
{
    ...
    while (true) {
        ...
        /* Ray-crossing solve — metric position from calibrated BS poses */
        lh2_point3d_t pts[NUM_SENSORS];
        int n = ray_cross_solve(BS_POSES, g_angles, now_us, pts);
