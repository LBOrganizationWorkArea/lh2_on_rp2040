...
# ============================================================
# Si ton X logiciel demande d'aller trop "à l'extérieur", 
# c'est que les vecteurs louchaient vers l'intérieur.
# On applique un léger Yaw (rotation Z) pour écarter les faisceaux.
# Commence à 0.0, puis essaie 1.0, 2.0, ou -1.0, -2.0 pour aligner ton X.

YAW_CORRECTION_BS4 = -1.5  # Tourne le faisceau gauche un peu plus vers la gauche
YAW_CORRECTION_BS10 = 1.5  # Tourne le faisceau droit un peu plus vers la droite

BS_POSES = {
    4:  {"pos": (-0.5, 0.0, 0.0), "rot": (YAW_CORRECTION_BS4, 0.0, 0.0)},
    10: {"pos": (+0.5, 0.0, 0.0), "rot": (YAW_CORRECTION_BS10, 0.0, 0.0)}   
}
...
def main():
    print("\n===================================================")
    print(" LBEES - PARALLEL CROSSING BEAMS + FINE TUNING")
    print("===================================================\n")
    ...
    if not coeffs_bs4 or not coeffs_bs10:
        print("[ERROR] Calibration coefficients missing.")
        return
